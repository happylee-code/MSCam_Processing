...
class MyCanvas(FigureCanvas):
    ...
    def draw_figure(self,x,ys,colors):
        ...
        self.axes.set_yticks(range(0, 255, 10))
        self.axes.grid(True)
...
class MatplotlibWidget(QWidget):
    ...
    def initUi(self):
        ...
        self.mpl.draw_figure([u'R', u'G', u'B'],[[100,200,300],[150,300,120]],["#800000", "#FF0000", "#C71585", "#4B0082", "#800080", "#6A5ACD", "#8B4513", "#D2691E", "#FF4500",
                      "#FF8C00", "#B8860B"])
        # 初始化显示甘特图
